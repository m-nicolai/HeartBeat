...
UBUNTU_TRANSLATION_DOMAIN="heartbeat.gulf00"
...
aptest.commands = bash $$PWD/heartBeat/tests/autopilot/run
aptest.depends  = sub-heartBeat

unittest.target   = check
unittest.commands = /usr/bin/qmltestrunner -input $$PWD/heartBeat/tests/unit
unittest.depends  = sub-heartBeat
